...
public class ItemBackpack extends TemplateItemBase implements CustomTooltipProvider {
    ...
    public String[] getTooltip(ItemInstance itemInstance, String originalTooltip) {
        ...
        if(prevHash != backpack.hashCode()) {
            prevHash = backpack.hashCode();
            cached = ArrayUtils.combineTwoArrays(new String[] { originalTooltip, "Content:" }, ArrayUtils.collectItemInstances(backpack.INVENTORY));
        }
        return cached;
    }
}
